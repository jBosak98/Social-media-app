...
import com.jakubbosak.udemycourse.yora.views.MainActivityAdapter;
...
public class MainActivity extends BaseAunthenticatedActivity implements View.OnClickListener, MainActivityAdapter.MainActivityListener {
    ...
    @Subscribe
    public void onContactRequestLoaded(final Contacts.GetContactRequestsResponse response){
        scheduler.invokeOnResume(response.getClass(), new Runnable() {
            @Override
            public void run() {
                swipeRefresh.setRefreshing(false);
