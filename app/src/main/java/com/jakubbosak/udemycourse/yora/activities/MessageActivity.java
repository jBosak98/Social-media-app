...
public class MessageActivity extends BaseAunthenticatedActivity implements View.OnClickListener {
    ...
    protected void onYoraCreate(Bundle savedState) {
        ...
        drawer = findViewById(R.id.activity_show_message_drawer);
        translateButton = (TextView) findViewById(R.id.activity_show_message_translate);
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        super.onWindowFocusChanged(hasFocus);
            translateOffset = drawer.getMeasuredHeight() - translateButton.getHeight();
    ...
    public void onClick(View view) {
        ...
        Log.e(String.valueOf(translationY), "HERE");


        currentAnimation = new AnimatorSet();
        currentAnimation.setDuration(300);
        currentAnimation.play(translateAnimator).before(colorAnimator);
